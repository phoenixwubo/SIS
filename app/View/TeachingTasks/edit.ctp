...
<?php echo $this->Form->create('TeachingTask'); ?>
	<fieldset>
		<legend><?php echo __('Edit Teaching Task'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TeachingTask.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TeachingTask.id'))); ?></li>
