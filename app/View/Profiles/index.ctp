<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('native'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['id_number']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['date_in']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['created']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['modified']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['native']); ?>&nbsp;</td>
		<td class="actions">
