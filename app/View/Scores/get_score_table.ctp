...
scoreInJson:[
	<?php foreach($scores as $idx=>$score):?>
	{
		...
		<?php echo $score['Scores'][$key]['Score'][$exam_name]; ?>
		<?php echo($key<$courseplanCoune-1)?',':'';?>
		<?php endforeach;?>
		<?php }else{?>
		regular:<?php echo $score['Scores'][0]['Score']['regular']; ?>,
		midterm:<?php echo $score['Scores'][0]['Score']['midterm']; ?>,
		final:<?php echo $score['Scores'][0]['Score']['final']; ?>,
		total:<?php echo $score['Scores'][0]['Score']['total']; ?>,
		s1:<?php echo $score['Scores'][0]['Score']['s1']; ?>,
		s2:<?php echo $score['Scores'][0]['Score']['s2']; ?>
		<?php }?>
